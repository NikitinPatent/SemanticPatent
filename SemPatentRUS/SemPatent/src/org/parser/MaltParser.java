...
import org.maltparser.MaltParserServiceRus;
...
public class MaltParser {
	...
	public static String maltParserRus(String modelName, String content){
        String out = "";
    ...
    public static Map<String, MaltParserServiceRus> MaltParserServices = new HashMap<String, MaltParserServiceRus>();
    ...
    private static List<String> maltParser(String modelName, ArrayList<String[]> tokens){
        ...
        try {
            ...
            {
                MaltParserServices.put(modelName, new MaltParserServiceRus());
                MaltParserServices.get(modelName).initializeParserModel("-c " + modelName + " -m parse -w . -lfi parser.log");
            }
            MaltParserServiceRus service = MaltParserServices.get(modelName);
